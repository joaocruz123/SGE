...
@section('header')
    <div class="page-header">
        <h1><i class="glyphicon glyphicon-plus"></i> Cordenadors / Create </h1>
    </div>
@endsection
...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <form action="{{ route('cordenadors.store') }}" method="POST">
                ...
                <div class="form-group @if($errors->has('nome')) has-error @endif">
                    ...
                    <input type="text" id="telefone-field" name="telefone" class="form-control" value="{{ old("telefone") }}"/>
